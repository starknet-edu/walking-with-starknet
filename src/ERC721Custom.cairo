...
@view
func is_breeder{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(account: felt) -> (
    is_approved: felt
) {
...
@view
func get_last_tokenID{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    tokenID: Uint256
) {
...
func register_me_as_breeder{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
    ...
    breeders.write(address=new_breeder_address, value=1);
    return (is_added=1);
}
...
func declare_animal{pedersen_ptr: HashBuiltin*, syscall_ptr: felt*, range_check_ptr}(
    ...
    animal_characteristics.write(new_tokenID, animal);
